...
import project_alias.webapp.WebUiResources;
import project_alias.dbsetup.HibernateSetup;
import project_alias.filter.NoDataFilter;
import project_alias.ioc.WebApplicationServerModule;
...
/**
 * Configuration point for Fire services Web Application.
 * 
 * @author Generated
 * 
 */
        ...
        try {
            ...
            getDefaultHost().attach(
                    new WebUiResources(
                            ...
                            injector,
                            "Fire services",
                            "An application server for Fire services",
                            "Project Alias",
                            "Authors",
                            webApp
                            ));
