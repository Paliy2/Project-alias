...
import project_alias.webapp.config.persons.PersonRoleWebUiConfig;
...
public class WebUiConfig extends AbstractWebUiConfig {
    ...
    public void initConfiguration() {
        ...
        .addModule("Equipment")
        .description("A module to create and manage Equipment classes.")
        .icon("mainMenu:help")
        .detailIcon("mainMenu:help")
        .bgColor("#ffeb3b")
        .captionBgColor("#c8b900")
        .menu()
        ...
        .addModule("Vehicles ")
        .description("A module to create and manage Vehicle entities.")
        .icon("mainMenu:systemservice")
        .detailIcon("mainMenu:systemservice")
        .bgColor("#DF711B")
        .captionBgColor("#ab5818")
        .menu()
        ...
        .addModule("Forms")
        .description("A module to create, manage daily forms.")
        .icon("mainMenu:reports")
        .detailIcon("mainMenu:reports")
        .bgColor("#64C9CF")
        .captionBgColor("#48a5ab")
        .menu()        
